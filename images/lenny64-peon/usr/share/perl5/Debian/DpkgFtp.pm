...
sub view_mirrors {
  if (-f '/usr/share/doc/dpkg-ftp/README.mirrors.txt') {
    system('/usr/bin/pager', '/usr/share/doc/dpkg-ftp/README.mirrors.txt');
  } elsif (-f '/usr/share/doc/dpkg-ftp/README.mirrors.txt.gz') {
    system('gzip -dc /usr/share/doc/dpkg-ftp/README.mirrors.txt.gz | pager');  
  } else {
    print "/usr/share/doc/dpkg-ftp/README.mirrors.txt(.gz): file not found.\n";
  }
}
