...
$Id: gdb.py.in,v 1.151 2008/05/21 11:02:51 rockyb Exp $"""
# -*- coding: utf-8 -*-
...
import bdb, disassemble, re, subcmd, sys, types
...
the default."""
    ...
    def do_disassemble(self, arg):
        """disassemble [obj-or-class] [start line number [end line number]]
...
is no Python file."""
        ...
        if fname == "":
           if self.mainpyfile == "":
               ...
               if get_confirmation(self,
                                   "Discard symbol table from %s'? (y or n)"
                                   % self.mainpyfile):
...
"""
        ...
        try:
            ...
            self.msg("IPython doesn't seem to be importable.")
            return False
        ...
        if hasattr(ipshell.IP, "magic_pydb"):
            # We an infinite loop when doing recursive edits
